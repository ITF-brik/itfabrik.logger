...
- `Register-LoggerSink -Type Serilog -Url <https://endpoint> [-APIKey ...] [-Headers @{...}] [-OnError Warn|Continue|Throw]`
...
- `Initialize-LoggerSerilog -Url <https://endpoint> [-APIKey ...] [-Headers @{...}] [-OnError Warn|Continue|Throw]`
