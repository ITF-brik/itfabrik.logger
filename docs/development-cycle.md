...
- Depuis `main`, creer la branche avec :
  ```powershell
  ./Scripts/New-DevelopmentCycle.ps1 -Type 'Evolution logger' -Objective 'Aligner le cycle de developpement avec ITFabrik.Stepper' -Push
  ```
- Le script :
...
- Convention de version :
  - stable : `ModuleVersion = '0.3.2'` et `PrivateData.PSData.Prerelease = $null`
  - prerelease : `ModuleVersion = '0.3.2'` et `PrivateData.PSData.Prerelease = 'alpha1'`
...
- Pour supprimer aussi la branche locale :
  ```powershell
  ./Scripts/Close-DevelopmentCycle.ps1 -Branch 'cycle/20260307-evolution-logger-aligner-le-cycle-de-developpement-avec-itfabrik-stepper'
  ```
